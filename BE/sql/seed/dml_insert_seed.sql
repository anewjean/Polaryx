...
INSERT INTO test_jungle_slam.messages (tab_id, sender_id, content, is_updated, sender_name, url, created_at, check_cnt, like_cnt, sparkle_cnt, pray_cnt, workspace_id) VALUES
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '실력다지기 발표 자료 제출 안하신 분들이 아직 많습니다. 금일 발표 자료 제출 해 주세요', 0, '이동석코치님', NULL, '2025-03-13 08:12:23', 1, 0, 1, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '안녕하십니까 정글러 여러분~ 다음주 월,화요일 코치 커피챗 신청을 원하시는 분들은 링크에 접속하신후 신청룰을 참고하여 기입 부탁드립니다.', 0, '이동석코치님', NULL, '2025-03-13 08:34:11', 0, 1, 1, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '<p><a target="_blank" rel="noopener noreferrer nofollow" href="https://docs.google.com/spreadsheets/d/1TJwPk-ouY0S6WZm54-8CovGEOavEiZ6M/edit?gid=1806443967#gid=1806443967">링크</a></p> 로 접속 바랍니다.', 0, '이동석코치님', NULL, '2025-03-13 08:36:55', 1, 1, 0, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '교육 현장 점검 종료 됐습니다.', 0, '유윤선코치님', NULL, '2025-03-13 08:49:02', 0, 0, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '307호는 301호의 발표가 늦어져서 지연될 예정이니 참고해주시면 감사하겠습니다. 다들 열심히 준비해주세요!', 0, '이동석코치님', NULL, '2025-03-13 09:03:44', 1, 1, 0, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '금일 오후 일정 30분 연기 하겠습니다. 1시 30분 : 301, 306호 아이디어 발표 2시 30분 :  307호 아이디어 발표 ', 0, '이동석코치님', NULL, '2025-03-13 09:19:10', 0, 1, 1, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '[긴급 공지] 누수 관련 점검 및 조치로 인해 지하 1층 식당 및 정글스테이지 방면 출입구를 일시적으로 폐쇄합니다\n     불편하시겠지만 다른 출입구를 이용하여 주시기 바랍니다.', 0, '유윤선코치님', NULL, '2025-03-13 09:32:41', 1, 0, 0, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '크래프톤 Culture팀 구성원 과의 티타임 공지 합니다\n일시 : 08/01(금) 오전 11시 ~ 11시 50분\n장소 : 정글 캠퍼스 곳곳(최초 집결장소 : 캠퍼스 1층 라운지)\n참여 구성원 : HR 분야 다양한 경력을 지닌 現 크래프톤 Culture팀 소속 구성원\n참석인원 : 최대 10명\n진행방식 : 교육생 4~5명과 구성원 1명 매칭 후 가벼운 티타임 진행\n주제 : 조직문화와 회사 생활 등에 대해 자유로운 질의응답\n모집 기간 : ~ 08/01 (금)\n 조직문화, 일반적인 비즈니스 매너, 크래프톤의 문화 및 회사 생활 전반 등을 확인 해 볼 수 있는 좋은 기회입니다.', 0, '이동석코치님', NULL, '2025-03-13 09:44:28', 1, 1, 1, 0, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '안녕하십니까 정글러 여러분\n다음주 월,화요일 코치 커피챗 신청을 원하시는 분들은 링크 에 접속 후 신청룰을 참고하여 기입 부탁드립니다.', 0, '유윤선코치님', NULL, '2025-03-13 09:57:12', 0, 1, 0, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '지난 4월에 진행한 1차 운동 이벤트(턱걸이 챌린지)에 이어, 교육생 여러분들의 의견을 수렴하여 2차 이벤트를 준비하였습니다\n다음과 같이 안내드리오니 많은 관심과 참여 바랍니다.\n\n🏀 농구 슛대결 참가 안내 🏀\n각 교육장의 명예를 건 치열한 슛 대결이 시작됩니다!', 0, '유윤선코치님', NULL, '2025-03-13 10:11:33', 1, 0, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '디스코드 초대링크입니다\n<a target="_blank" rel="noopener noreferrer nofollow" href= https://discord.gg/jqaYP7rP56>[성공적인 나만무를 위한 크래프톤 정글 3기 민상기님의 조언]</a>\n나만무 프로젝트를 들고 약 20여 곳의 면접을 본 경험을 바탕으로 제 의견을 공유합니다. 참고로 저는 주로 소규모 스타트업 위주로 면접에 참여한 점 참고 부탁드립니다.\n어투는 다소 확정적이지만, 매우 주관적인 의견임을 사전에 말씀드립니다.\n저와 다른 의견도 언제든지 환영합니다.🤗\n 난 백엔드 개발자 할거니까 React몰라도 되겠지? -> (소규모 스타트업 한정) 저는 첫 커리어를 Node 백엔드 개발자로 입사했지만 입사 후에는 파이썬 백엔드, C++ 라이브러리 개발, Vue, Flutter, Node를 모두 다뤄야 했습니다.', 0, '이동석코치님', NULL, '2025-03-13 10:23:19', 0, 1, 1, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'),'3시 20분 부터 307호 발표 시작합니다.',0,'이동석코치님', NULL, '2025-03-13 10:36:01', 1, 0, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'),'내일 1시부터 반별로 나만무 발표합니다. \n 306호는 1시에 바로 시작하고, \n 307호 -> 301호 순서로 합니다. ',0,'이동석코치님', NULL, '2025-03-13 10:49:44', 0, 1, 0, 1, 1),
     (1, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'네 알겠습니다',0,'', NULL, '2025-03-13 11:03:12', 1, 1, 1, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '기획 발표는 최대한 명확하게 문제 정의를 설명하는 데 집중해 주세요.', 0, '이동석코치님', NULL, '2025-03-13 11:16:55', 0, 0, 1, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '4시 40분 부터 301호 발표 시작합니다.', 0, '유윤선코치님', NULL, '2025-03-13 11:29:44', 1, 0, 0, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '교육동 4층 402호 ~ 405호 교육장 탈취 등 작업으로 인해 7/18(금)까지 출입이 금지됩니다. 또한, 해당 공간 내 에어콘 및 전열교환기 사용이 절대 금지됩니다. 참고하여 주시기 바랍니다. 감사합니다.', 0, '유윤선코치님', NULL, '2025-03-13 11:43:12', 1, 1, 0, 0, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '내일 일정 사전 공유드립니다.\n1400-1700 나만무 중간 발표  (장소: 정글 스테이지)\n내일 발표는 306호, 307호, 301호 순으로 진행됩니다.\n306호는 14시까지 정글 스테이지에 착석 해 주시기 바랍니다.\n앞 반의 발표가 마무리될 즈음 공지드릴 예정이니, 다음 반 발표자분들은 미리 정글 스테이지로 이동해 주시기 바랍니다.\n또한, 다른 반의 기획 발표를 듣고 싶으신 분은 자유롭게 참여하실 수 있습니다.', 0, '유윤선코치님', NULL, '2025-03-13 11:56:01', 0, 1, 1, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '노동부 심사위원단이 7월 7일(월) 오후 1시부터 최대 4시간 동안 교육 현장 점검을 진행할 예정입니다.\n오후 2시가 아니라 1시입니다!!\n점심 식사 후에 모든 교육생들은 교육장에서 학습 해 주시기 바랍니다.', 0, '유윤선코치님', NULL, '2025-03-13 12:09:44', 1, 0, 1, 0, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '<p>안녕하십니까 정글러 여러분~\n다음주 월,화요일 코치 커피챗 신청을 원하시는 분들은 <a target="_blank" rel="noopener noreferrer nofollow" href="https://github.com/Slack-LMS-Project-Team3/Slack-LMS/blob/channel_test/FE/public/sw.js">링크</a>에 접속 후 신청룰을 참고하여 기입 부탁드립니다.\n저녁식사 맛있게 드세요. 정글</p>', 0, '유윤선코치님', NULL, '2025-03-13 12:23:12', 0, 1, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '오늘 발표 순서가 유동적일 수 있으니, 미리 발표 자료를 점검해 주세요.', 0, '이동석코치님', NULL, '2025-03-13 12:36:55', 1, 0, 0, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '정글 스테이지는 13시부터 사용 가능합니다. 해당 시간 이전에는 출입을 자제해 주세요.', 0, '이동석코치님', NULL, '2025-03-13 12:49:44', 1, 1, 1, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '발표 전 리허설은 각 조에서 자율적으로 진행해 주세요. 공간 예약은 커뮤니티보드 참고.', 0, '이동석코치님', NULL, '2025-03-13 13:03:12', 0, 1, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '307호 발표자는 10분 전까지 정글 스테이지 앞 대기 부탁드립니다.', 0, '이동석코치님', NULL, '2025-03-13 13:16:55', 1, 0, 1, 0, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '<p>안녕하십니까 정글러 여러분~\n다음주 월,화요일 코치 커피챗 신청을 원하시는 분들은 <a target="_blank" rel="noopener noreferrer nofollow" href="https://github.com/Slack-LMS-Project-Team3/Slack-LMS/blob/channel_test/FE/public/sw.js">링크</a>에 접속 후 신청룰을 참고하여 기입 부탁드립니다.\n저녁식사 맛있게 드세요. 정글</p>', 0, '유윤선코치님', NULL, '2025-03-13 13:29:44', 1, 1, 0, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '오늘 발표 순서가 유동적일 수 있으니, 미리 발표 자료를 점검해 주세요.', 0, '이동석코치님', NULL, '2025-03-13 13:43:12', 0, 1, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '정글 스테이지는 13시부터 사용 가능합니다. 해당 시간 이전에는 출입을 자제해 주세요.', 0, '이동석코치님', NULL, '2025-03-13 13:56:01', 1, 0, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '기획 발표는 최대한 명확하게 문제 정의를 설명하는 데 집중해 주세요.', 0, '이동석코치님', NULL, '2025-03-13 14:09:44', 1, 1, 0, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '발표 전 리허설은 각 조에서 자율적으로 진행해 주세요. 공간 예약은 커뮤니티보드 참고.', 0, '이동석코치님', NULL, '2025-03-13 14:23:12', 0, 1, 1, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '307호 발표자는 10분 전까지 정글 스테이지 앞 대기 부탁드립니다.', 0, '이동석코치님', NULL, '2025-03-13 14:36:55', 1, 0, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '오늘도 발표자료를 슬라이드 형태로 제출하지 않으신 분들은 꼭 제출 부탁드립니다.', 0, '이동석코치님', NULL, '2025-03-13 14:49:44', 1, 1, 0, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '점심시간 이후에는 에너지 충전을 충분히 하고 발표에 임해 주세요!', 0, '이동석코치님', NULL, '2025-03-13 15:03:12', 0, 1, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '발표 피드백은 슬랙 채널에 공지된 양식을 참고해서 작성 바랍니다.', 0, '이동석코치님', NULL, '2025-03-13 15:16:55', 1, 0, 1, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '내일 스테이지 예약은 오늘 저녁 8시까지 마감됩니다. 늦지 않게 신청해주세요.', 0, '이동석코치님', NULL, '2025-03-13 15:29:44', 1, 1, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '오늘 하루도 수고 많으셨습니다. 각 조 피드백은 내일 오전까지 정리해 드릴게요.', 0, '이동석코치님', NULL, '2025-03-13 15:43:12', 0, 1, 0, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '오늘도 발표자료를 슬라이드 형태로 제출하지 않으신 분들은 꼭 제출 부탁드립니다.', 0, '이동석코치님', NULL, '2025-03-13 15:56:01', 1, 0, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '점심시간 이후에는 에너지 충전을 충분히 하고 발표에 임해 주세요!', 0, '이동석코치님', NULL, '2025-03-13 16:09:44', 1, 1, 0, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '발표 피드백은 슬랙 채널에 공지된 양식을 참고해서 작성 바랍니다.', 0, '이동석코치님', NULL, '2025-03-13 16:23:12', 0, 1, 1, 0, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '내일 스테이지 예약은 오늘 저녁 8시까지 마감됩니다. 늦지 않게 신청해주세요.', 0, '이동석코치님', NULL, '2025-03-13 16:36:55', 1, 0, 1, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '오늘 하루도 수고 많으셨습니다. 각 조 피드백은 내일 오전까지 정리해 드릴게요.', 0, '이동석코치님', NULL, '2025-03-13 16:49:44', 1, 1, 0, 1, 1),
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '식당 운영 관련 정책 리마인드 및 음식물 쓰레기 최소화를 위한 협조 요청\n-외부음식은 20시 이후에만 식당에서 취식 가능합니다(단, 일요일은 종일 가능). 외부음식 취식 관련 정책을 반드시 준수하여 주세요.\n 식당에서 배출되는 음식물 쓰레기 최소화를 위해, 10인 이상의 회식(외부 식당 이용 또는 배달 음식 취식)이 예정되어 있을 경우 1일 전까지 코치진 또는 운영팀에 알려 주시기 바랍니다.', 0, '이동석코치님', NULL, '2025-03-13 17:03:12', 0, 1, 1, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '안녕하십니까 정글러 여러분\n 다음주 월,화요일 코치 커피챗 신청을 원하시는 분들은 링크 에 접속 후 신청룰을 참고하여 기입 부탁드립니다.', 0, '유윤선코치님', NULL, '2025-03-13 17:16:55', 1, 0, 1, 0, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '<p><a target="_blank" rel="noopener noreferrer nofollow" href="https://docs.google.com/spreadsheets/d/1TJwPk-ouY0S6WZm54-8CovGEOavEiZ6M/edit?gid=1806443967#gid=1806443967">링크</a></p> 로 접속 바랍니다.', 0, '유윤선코치님', NULL, '2025-03-13 17:29:44', 1, 1, 0, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), 'AWS 정글 8기  Paddlet 주소입니다.\n<p><a target="_blank" rel="noopener noreferrer nofollow" href="https://padlet.com/feaver85/8-hw1426cs3xbpkncr">AWS링크</a></p> \n AWS 클라우드 환경 관련 질문 있으신 분들은 상기 사이트에 이용 해보시기 바랍니다.', 0, '유윤선코치님', NULL, '2025-03-13 17:43:12', 0, 1, 1, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '4시 40분 부터 301호 발표 시작합니다.', 0, '유윤선코치님', NULL, '2025-03-13 17:56:01', 1, 0, 1, 0, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '교육동 4층 402호 ~ 405호 교육장 탈취 등 작업으로 인해 7/18(금)까지 출입이 금지됩니다. 또한, 해당 공간 내 에어콘 및 전열교환기 사용이 절대 금지됩니다. 참고하여 주시기 바랍니다. 감사합니다.', 0, '유윤선코치님', NULL, '2025-03-13 18:09:44', 1, 1, 1, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '내일 일정 사전 공유드립니다.\n1400-1700 나만무 중간 발표  (장소: 정글 스테이지)\n내일 발표는 306호, 307호, 301호 순으로 진행됩니다.\n306호는 14시까지 정글 스테이지에 착석 해 주시기 바랍니다.\n앞 반의 발표가 마무리될 즈음 공지드릴 예정이니, 다음 반 발표자분들은 미리 정글 스테이지로 이동해 주시기 바랍니다.\n또한, 다른 반의 기획 발표를 듣고 싶으신 분은 자유롭게 참여하실 수 있습니다.', 0, '유윤선코치님', NULL, '2025-03-13 18:23:12', 0, 1, 0, 1, 1),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '노동부 심사위원단이 7월 7일(월) 오후 1시부터 최대 4시간 동안 교육 현장 점검을 진행할 예정입니다.\n오후 2시가 아니라 1시입니다!!\n점심 식사 후에 모든 교육생들은 교육장에서 학습 해 주시기 바랍니다.', 0, '유윤선코치님', NULL, '2025-03-13 18:36:55', 1, 0, 1, 1, 1),
     (2,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'여기 이모지 보내지나요 😶',0,'', NULL, '2025-03-14 08:12:23', 1, 1, 0, 1, 1),
     (2, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '네 잘 보내집니다. ^^', 0, '유윤선코치님', NULL, '2025-03-14 08:34:11', 0, 1, 1, 0, 1),
     (2, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '질문이 있습니다', 0, '박은채', NULL, '2025-03-14 08:36:55', 1, 0, 1, 1, 1),
     (2, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAADDDD'), '점검 몇 시에 끝날까요?', 0, '신명훈', NULL, '2025-03-14 08:49:02', 0, 1, 0, 1, 1),
     (2, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '질문이 있습니다', 0, '박은채', NULL, '2025-03-14 09:03:44', 1, 1, 1, 0, 1),
     (2, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '이거 왜 바로바로 안 보내지죠?', 0, '박은채', NULL, '2025-03-14 09:19:10', 0, 1, 1, 1, 1),
     (2, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '점검은 14:00 ~ 15:00 까지 진행될 예정입니다. 불편을 드려서 죄송합니다 ', 0, '유윤선코치님', NULL, '2025-03-14 09:32:41', 1, 0, 1, 1, 1),
     (2, UNHEX('CCCCCAAAAAAAAAAAAAAAAEEAAAAADDDD'), '혹시 예비군 관련서류는 어떻게 진행하면 될까요', 0, '이찬석', NULL, '2025-03-14 09:44:28', 1, 1, 0, 1, 1),
     (2, UNHEX('CCCCCAAAAAAAAAAAAAAAAEEAAAAADDDD'), '넵 감사합니다!', 0, '이찬석', NULL, '2025-03-14 09:57:12', 0, 1, 1, 0, 1),
     (2, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '<증명서 요청 방법>\n\n성명, 생년월일, 참여 과정명 (예: 홍길동, 2000.01.01, 정글 8기)\n문서 발급 사유 (예: 예비군 훈련 연기, 실업급여 지급 증빙, 교육참여 확인서)\n문서 제출처 (예: 예비군 동대, 고용센터)\n문서상 반드시 포함되어야 하는 내용 기재 (예: ① 이름, ② 생년월일, ③ 참여 과정명, ④ MM.DD ~ MM.DD 기간의 출석기록)', 0, '유윤선코치님', NULL, '2025-03-14 10:11:33', 1, 0, 1, 1, 1),
     (2,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'안녕하세요!',0,'', NULL, '2025-03-14 10:23:19', 0, 1, 1, 0, 1),
     (2,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'질문이 있습니다!',0,'', NULL, '2025-03-14 10:36:01', 1, 1, 0, 1, 1),
     (2,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'혹시 기숙사 에어콘이 중간에 멈추던데 혹시 언제 꺼지는지 알 수 있을까요?',0,'', NULL, '2025-03-14 10:49:44', 1, 0, 1, 1, 1),
     (2,UNHEX('8430DCCE5C1411F0A6350242AC110002'),'에어콘은 기숙사에서 점심에 자동으로 꺼지게 되어있습니다^^ 식사후 방에가셔서 다시 키면 될꺼같습니다.',0,'이동석코치님', NULL, '2025-03-14 11:03:12', 0, 1, 1, 0, 1),
     (3, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '외워서 푸는 건 한계가 있어요. 원리를 알고 코드를 짜면 언젠가 분명히 실력이 폭발합니다.', 0, '이동석코치님', NULL, '2025-03-15 08:12:23', 25, 0, 23, 0, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAADDDD'), '넵, 감사합니다', 0, '신명훈', NULL, '2025-03-15 08:34:11', 0, 1, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '넵, 감사합니다', 0, '박은채', NULL, '2025-03-15 08:36:55', 1, 0, 1, 1, 1),
     (3, UNHEX('545A4AB45C8611F0A8650242AC110002'), '재귀 함수 아직도 개념이 헷갈리는데, 쉽게 이해하는 법 있을까?', 0, '정경호', NULL, '2025-03-15 08:49:02', 0, 23, 10, 0, 1),
     (3, UNHEX('802E0FE95C8611F0A8650242AC110002'), '완전탐색 문제 푸는 팁 있으면 공유 부탁!', 0, '최효식', NULL, '2025-03-15 09:03:44', 0, 10, 12, 23, 1),
     (3, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '기초 정렬 구현 코드 같이 보실 분?', 0, '박은채', NULL, '2025-03-15 09:19:10', 22, 1, 0, 1, 1),
     (3, UNHEX('05EA49CFD91F41A0BE63CACE1718DE71'), '정수론은 소수 판별부터 머리가 아프네.. 좋은 문제 추천?', 0, '안유진', NULL, '2025-03-15 09:32:41', 1, 0, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAADDDD'), '배열 인덱스 실수 너무 자주 나네.. 디버깅 팁 있음?', 0, '신명훈', NULL, '2025-03-15 09:44:28', 0, 1, 1, 0, 1),
     (3, UNHEX('545A4AB45C8611F0A8650242AC110002'), '시간 복잡도 줄이는 패턴 좀 공유해주실 수 있나요?', 0, '정경호', NULL, '2025-03-15 09:57:12', 1, 1, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAAAAAA'), '완전탐색에서 visited 배열 없으면 안 되나?', 0, '김윤석', NULL, '2025-03-15 10:11:33', 0, 1, 0, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAEEAAAAADDDD'), '재귀 함수 depth가 깊어질 때 에러 나는 거 해결법?', 0, '이찬석', NULL, '2025-03-15 10:23:19', 1, 0, 1, 1, 1),
     (3, UNHEX('9F95C1F15C8411F0A8650242AC110002'), '이중 for문 쓸 때 시간복잡도 항상 n^2인가요?', 0, '김준혁', NULL, '2025-03-15 10:36:01', 1, 1, 0, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAADDDD'), '배열 복사 shallow, deep 차이 다시 한 번 정리해볼까요?', 0, '신명훈', NULL, '2025-03-15 10:49:44', 0, 1, 1, 1, 1),
     (3, UNHEX('1F61345F5C8611F0A8650242AC110002'), '기초 알고리즘 문제 중 추천 좀 해주세요!', 0, '임구철', NULL, '2025-03-15 11:03:12', 1, 0, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '반복문으로 풀다가 재귀로 바꾸니 코드가 더 간결해졌어요!', 0, '박은채', NULL, '2025-03-15 11:16:55', 1, 1, 1, 0, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAEEAAAAADDDD'), '문자열 정렬할 때 기준 문자 지정하는 방법 알면 좋을 듯요.', 0, '이찬석', NULL, '2025-03-15 11:29:44', 0, 1, 1, 1, 1),
     (3, UNHEX('545A4AB45C8611F0A8650242AC110002'), '재귀로 푸는 게 이득인 상황 예시 아시는 분?', 0, '정경호', NULL, '2025-03-15 11:43:12', 1, 0, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAADDDD'), '문자열 자르는 split()이랑 슬라이싱 차이 궁금합니다.', 0, '신명훈', NULL, '2025-03-15 11:56:01', 1, 1, 0, 1, 1),
     (3, UNHEX('802E0FE95C8611F0A8650242AC110002'), '문자열 관련해서 자주 쓰는 메서드 모아볼까요?', 0, '최효식', NULL, '2025-03-15 12:09:44', 0, 1, 1, 1, 1),
     (3, UNHEX('545A4AB45C8611F0A8650242AC110002'), '정렬 stable vs unstable 개념 깔끔하게 이해한 분?', 0, '정경호', NULL, '2025-03-15 12:23:12', 1, 1, 1, 0, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAAAAAA'), '재귀 함수에서 return이 언제 되는지 직관적으로 잘 모르겠어.', 0, '김윤석', NULL, '2025-03-15 12:36:55', 1, 0, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '네 알겠습니다', 0, '박은채', NULL, '2025-03-15 12:49:44', 0, 1, 1, 1, 1),
     (3, UNHEX('32F2411E5C8611F0A8650242AC110002'), '정렬은 어느 알고리즘이 제일 직관적인 것 같아?', 0, '임준혁', NULL, '2025-03-15 13:03:12', 1, 1, 0, 1, 1),
     (3, UNHEX('545A4AB45C8611F0A8650242AC110002'), '배열 최대값 찾는 반복문 최적화 방법 있을까요?', 0, '정경호', NULL, '2025-03-15 13:16:55', 1, 0, 1, 1, 1),
     (3, UNHEX('6F0AC5FD5C8411F0A8650242AC110002'), '기초 알고리즘 공부할 때 제일 먼저 해야 할 건 뭐라고 생각해?', 0, '김세현', NULL, '2025-03-15 13:29:44', 1, 1, 1, 0, 1),
     (3, UNHEX('545A4AB45C8611F0A8650242AC110002'), '기초 정렬은 시각적으로 보면 이해가 더 잘 되더라', 0, '정경호', NULL, '2025-03-15 13:43:12', 0, 1, 1, 1, 1),
     (3, UNHEX('BEA1232F5C8511F0A8650242AC110002'), '완전탐색에서 pruning 꼭 써야 하나요?', 0, '박은범', NULL, '2025-03-15 13:56:01', 1, 1, 0, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAEEAAAAADDDD'), '재귀보다 반복문이 더 편하지 않나요? 혹시 반례 있음?', 0, '이찬석', NULL, '2025-03-15 14:09:44', 1, 0, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAAAAAA'), '재귀 함수 디버깅할 때 call stack 보는 게 도움 되나요?', 0, '김윤석', NULL, '2025-03-15 14:23:12', 0, 1, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAADDDD'), '수학적 사고 필요한 정수론 유형 정리하면 도움 될 듯요.', 0, '신명훈', NULL, '2025-03-15 14:36:55', 1, 1, 0, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '배열 순서 바꾸는 함수 중 가장 효율적인 거 뭐 있을까요?', 0, '박은채', NULL, '2025-03-15 14:49:44', 1, 0, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAEEAAAAADDDD'), '문자열 길이 제한 있을 때 어떻게 처리하시나요?', 0, '이찬석', NULL, '2025-03-15 15:03:12', 0, 1, 1, 1, 1),
     (3, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAADDDD'), '반복문 변수 i 대신 다른 알파벳 쓰면 가독성 좋아질까요?', 0, '신명훈', NULL, '2025-03-15 15:16:55', 1, 1, 1, 0, 1),
     (3, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '<p><a target="_blank" rel="noopener noreferrer nofollow" href="https://abundant-carver-c3f.notion.site/2-1bfd5b3e6ec5805f8692e887523a3441?pvs=4">목요일 시험대비 유형별 문제 리스틉니다</a><br>문제 다풀어서 풀거없다 하는 알고리즘 똑똑이들이나 저처럼 플레문제 따위는 시원하게 포기한 헛똑똑이들은 참고하세욧</p>', 0, '박은채', NULL, '2025-03-15 15:29:44', 1, 1, 0, 1, 1),
     ...
     0, '박은범', NULL, '2025-03-15 15:43:12', 1, 1, 0, 1, 1),
     ...
     0, '김윤석', NULL, '2025-03-15 15:56:01', 0, 1, 1, 1, 1),
     ...
     0, '이재웅', NULL, '2025-03-15 16:09:44', 1, 0, 1, 1, 1),
