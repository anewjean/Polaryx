...
INSERT INTO jungle_slam.messages (tab_id,sender_id,content,is_updated,sender_name, created_at) VALUES
     ...
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '교육 현장 점검 종료 됐습니다.', 0, '유윤선코치님', '2024-07-12 18:26:13'),
     ...
     (16, UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAADDDD'), '참석', 0, '신명훈', '2024-07-11 20:57:03'),
     ...
     (16, UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'), '참석', 0, '박은채', '2024-07-07 19:45:28'),
     ...
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '식당 운영 관련 정책 리마인드 및 음식물 쓰레기 최소화를 위한 협조 요청\n-외부음식은 20시 이후에만 식당에서 취식 가능합니다(단, 일요일은 종일 가능). 외부음식 취식 관련 정책을 반드시 준수하여 주세요.\n 식당에서 배출되는 음식물 쓰레기 최소화를 위해, 10인 이상의 회식(외부 식당 이용 또는 배달 음식 취식)이 예정되어 있을 경우 1일 전까지 코치진 또는 운영팀에 알려 주시기 바랍니다.', 0, '이동석코치님', '2024-07-08 14:33:19'),
     (1, UNHEX('CEF6C2175C1711F0A8650242AC110002'), '안녕하십니까 정글러 여러분\n 다음주 월,화요일 코치 커피챗 신청을 원하시는 분들은 링크 에 접속 후 신청룰을 참고하여 기입 부탁드립니다.', 0, '유윤선코치님', '2024-07-05 21:16:23'),
     (16, UNHEX('CCCCCAAAAAAAAAAAAAAAAEEAAAAADDDD'), '참석', 0, '이찬석', '2024-07-09 09:41:18'),
     ...
     (1, UNHEX('8430DCCE5C1411F0A6350242AC110002'), '307호는 301호의 발표가 늦어져서 지연될 예정이니 참고해주시면 감사하겠습니다. 다들 열심히 준비해주세요!', 0, '이동석코치님', '2024-07-12 22:17:09'),
     ...
     (2,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'사실 없습니다',0,'', '2024-07-10 16:02:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'이모지 보내지나요 😶',0,'', '2024-07-10 16:03:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'🐿️',0,'', '2024-07-10 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'```안녕```',0,'', '2024-07-10 16:10:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'굵게 기울임꼴 취소선',0,'', '2024-07-10 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<p><strong>굵게</strong><br><em>기울임꼴</em></p><p><br><s>취소선</s></p>',0,'', '2024-07-10 17:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<p></p><p></p>',0,'', '2024-07-10 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<p>안녕하세요~</p><p></p>',0,'', '2024-07-10 18:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<p><strong>굵은 글씨 잘 보내지나요</strong></p><p></p>',0,'', '2024-07-10 19:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<p><em>기울임꼴</em></p><p></p>',0,'', '2024-07-10 20:13:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<p><s>취소선</s></p><p></p>',0,'', '2024-07-11 22:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<p>😶</p><p></p>',0,'', '2024-07-11 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<p><code>print("안뇽")</code></p><p></p>',0,'', '2024-07-11 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'<pre><code>print("''이건 코드블록이당")</code></pre>',0,'', '2024-07-11 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAABBBAAAEEAAAAADDDD'),'```코드블록 ```',0,'', '2024-07-11 16:12:26'),
     (1,UNHEX('05EA49CFD91F41A0BE63CACE1718DE71'),'안녕?',0,'', '2024-07-11 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAAAAAA'),'네네~~~~',0,'', '2024-07-12 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAAAAAAAAAAAAAAAAAAA'),'안녕하세요~~~~',0,'', '2024-07-12 16:12:26'),
     (1,UNHEX('CCCCCAAAAAAAAAAAAAAAAEEAAAAADDDD'),'안녕하세요',0,'', '2024-07-13 16:12:26');
