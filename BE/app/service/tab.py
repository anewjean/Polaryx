...
class TabService:
    ...
    def create_tab(self, user_id: str, workspace_id: int, tab_name: str, section_id: int, subsection_id: int):
    ...
    def find_tab(self, workspace_id: int, tab_id: int) -> TabDetailInfo:
        rows = self.repo.find(workspace_id, tab_id)
