 ...
 * 1️⃣ **스모크 테스트**
  ...
  * 2️⃣ **실시간 테스트**
      ...
      - 평균 연결 지연시간: 1,083ms
      - 검증 목적: 빈번한 연결/해제 상황에서의 시스템 안정성
      - [테스트 결과](./BE/docs/test/ws-realtime-summary.json)
...
|:------------:|:------------:|:-------------:|:---------------:|:---------------:|:---------------:|
| 스모크 | 20 | 100% | 64ms | 187ms | 송신: 756<br>수신: 10,419 |
| 실시간 | 400 | 99.9% | 61ms | 89ms | 송신: 15,695<br>수신: - |
| 홀드 | 1,200 | 100% | 3,020ms | 9,790ms | 송신: 278,118<br>수신: 5,435,263 |
