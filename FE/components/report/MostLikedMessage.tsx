...
const dummyLikedMessages = [
  { senderId: 'user1', msgId: 101, imgSrc: 'https://ca.slack-edge.com/E01DL1Z9D6Z-U085L9ZRDQW-21ecc433d650-512', nickname: '이동석', time: '오후 2:30', content: '외워서 푸는 건 한계가 있어요. 원리를 알고 코드를 짜면 언젠가 분명히 실력이 폭발합니다.', showProfile: true, fileUrl: null, isUpdated: 0, checkCnt: 152, clapCnt: 128, prayCnt: 98, sparkleCnt: 85, likeCnt: 77, myToggle: { check: false, clap: true, pray: false, sparkle: true, like: false } },
  { senderId: 'user2', msgId: 102, imgSrc: 'https://ca.slack-edge.com/T01GNAFL1MX-U08GSGL5ZK3-0c7f0765f91c-512', nickname: '박은채', time: '오전 10:15', content: '<p><a target="_blank" rel="noopener noreferrer nofollow" href="https://abundant-carver-c3f.notion.site/2-1bfd5b3e6ec5805f8692e887523a3441?pvs=4">목요일 시험대비 유형별 문제 리스핏니다</a><br>문제 다풀어서 풀거없다 하는 알고리즘 똑똑이들이나 저처럼 플레문제 따위는 시원하게 포기한 헛똑똑이들은 참고하세욧</p>', showProfile: true, fileUrl: null, isUpdated: 1, checkCnt: 128, clapCnt: 98, prayCnt: 85, sparkleCnt: 77, likeCnt: 65, myToggle: { check: false, clap: false, pray: false, sparkle: false, like: false } },
  { senderId: 'user3', msgId: 103, imgSrc: 'https://ca.slack-edge.com/T01GNAFL1MX-U08GJQ125LL-3323bcb28d3c-512', nickname: '이찬석', time: '오후 11:09', content: '<p><a target="_blank" rel="noopener noreferrer nofollow" href="https://velog.io/@qnfrma1997/%EC%A0%95%EA%B8%80-CPH-Competitive-Companion%EC%9D%8[…]EC%8A%A4%ED%8A%B8-%EC%84%A4%EC%A0%95-%EA%B0%80%EC%9D%B4%EB%93%9C">📖[정글]백준 자동 테스트 설정 가이드📖</a><br>백준 문제풀이에 도움되는 내용 공유합니다. 정글 301호 1주차 4팀 "윤석주"님이 알려주신 내용을 바탕으로 작성했습니다.</p>', showProfile: true, fileUrl: null, isUpdated: 0, checkCnt: 98, clapCnt: 85, prayCnt: 77, sparkleCnt: 65, likeCnt: 51, myToggle: { check: false, clap: false, pray: false, sparkle: false, like: false } },
