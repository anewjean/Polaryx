...
export default function ProfilePage() {
  ...
  return (
    <div
      className="flex flex-col h-full w-full gap-4 py-4 bg-background text-foreground"
      style={{ flexBasis: "100%" }} 
    >
      {/* 헤더 (프로필과 닫기 버튼) */}
      ...
      <div className="flex flex-col gap-4 overflow-y-auto scrollbar-thin pt-4 border-t">        
        {/* 이메일 */}
